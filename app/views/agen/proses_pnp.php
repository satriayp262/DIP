...
$aksi = $_GET['aksi'];
if ($aksi == "tambah") {
    $db->tambah_penumpang($_POST['nama_po'], $_POST['bulan'], $_POST['tahun'], $_POST['jumlah']);
    header("location:tampil_pnp.php?success=tambah");
} elseif ($aksi == "update") {
    $db->update_penumpang($_POST['id_pa'], $_POST['nama_po'], $_POST['bulan'], $_POST['tahun'], $_POST['jumlah']);
