...
<body>
    ...
    <div class="content">
        ...
        <div class="garis"></div>
        <div class="container">
            <h4>Selamat Datang Di Halaman Agen!</h4>
            <h6>Dashboard agen Terminal Bus Cilacap menjadi kendali utama untuk membantu tugas agen dalam menginputkan jadwal perjalanan bus dan menginputkan data jumlah penumpang bulanan dengan efisien. Dengan informasi yang terkini tentang jadwal keberangkatan dan kedatangan bus,</h6><br>
        </div>
        <div class="footer">
