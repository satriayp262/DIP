...
if ($aksi == "tambah") {
    ...
    header("location:tampil_jdwl_dishub.php?success=tambah");
} elseif ($aksi == "update") {
    $db->update_jadwal($_POST['id_jadwal'], $_POST['id_bus'], $_POST['tujuan'], $_POST['kelas'], $_POST['jam_datang'], $_POST['jam_berangkat']);
    header("location:tampil_jdwl_dishub.php?success=update");
} elseif ($aksi == "hapus") {
    $db->hapus_jadwal($_GET['id_jadwal']);
    header("location:tampil_jdwl_dishub.php?success=hapus");
}
