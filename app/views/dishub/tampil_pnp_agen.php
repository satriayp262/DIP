                ...
                <tbody class="table-light">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit_pnp_admin.php?id_pa=<?php echo $x['id_pa']; ?>&aksi=edit" class="btn btn-warning">edit</a>
                                <a href="proses_pnp_admin.php?id_pa=<?php echo $x['id_pa']; ?>&aksi=hapus" class="btn btn-danger">hapus</a>
                            </td>
                        </tr>
                    <?php
                    }
